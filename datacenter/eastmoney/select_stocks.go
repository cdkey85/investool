...
type StockInfo struct {
	...
	ChangeRate            float64     `json:"change_rate" title:"涨跌幅"`
	VolumeRatio           float64     `json:"volume_ratio" title:"量比"`
	NewPrice              interface{} `json:"NEW_PRICE" title:"最新价"`
	HighPrice             float64     `json:"high_price" title:"最高价"`
	LowPrice              float64     `json:"low_price" title:"最低价"`
	PreClosePrice         float64     `json:"pre_close_price" title:"昨收价"`
	Volume                int64       `json:"volume" title:"成交量"`
	DealAmount            int64       `json:"deal_amount" title:"成交额"`
	...
	Amplitude                 float64  `json:"amplitude" title:"振幅"`
	...
	NetInflow                 float64  `json:"net_inflow" title:"当日净流入额" need:"0"`
	...
	NowinterstRatio           int64    `json:"nowinterst_ratio" title:"当日增仓占比" need:"0"`
	...
	Ddx                       float64  `json:"ddx" title:"当日DDX" need:"0"`
	Ddx3D                     float64  `json:"ddx_3d" title:"3日DDX" need:"0"`
	Ddx5D                     float64  `json:"ddx_5d" title:"5日DDX" need:"0"`
	DdxRed10D                 int16    `json:"ddx_red_10d" title:"10日内DDX飘红天数" need:"0"`
